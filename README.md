...
You will use the simple application during this tutorial, which has a [frontend](https://github.com/openshift/pipelines-vote-ui/tree/pipelines-1.16) and [backend](https://github.com/openshift/pipelines-vote-api/tree/pipelines-1.16)
...
Now we need to configure webhook-url on [backend](https://github.com/openshift/pipelines-vote-api/tree/pipelines-1.16) and [frontend](https://github.com/openshift/pipelines-vote-ui/tree/pipelines-1.16) source code repositories with the Route we exposed previously.
...
>***Note:***
>
>Fork the [backend](https://github.com/openshift/pipelines-vote-api/tree/pipelines-1.16) and [frontend](https://github.com/openshift/pipelines-vote-ui/tree/pipelines-1.16) source code repositories so that you have sufficient privileges to configure GitHub webhooks.
...
- Follow the above procedure to configure the webhook on [frontend](https://github.com/openshift/pipelines-vote-ui/tree/pipelines-1.16) repo
...
When we perform any push event on the [backend](https://github.com/openshift/pipelines-vote-api/tree/pipelines-1.16) the following should happen.
...
To github.com:<github-username>/pipelines-vote-api.git
   72c14bb..97d3115  pipelines-1.16 -> pipelines-1.16
```
