...
You will use the simple application during this tutorial, which has a [frontend](https://github.com/openshift/pipelines-vote-ui/tree/pipelines-1.21) and [backend](https://github.com/openshift/pipelines-vote-api/tree/pipelines-1.21)
...
To github.com:<github-username>/pipelines-vote-api.git
   72c14bb..97d3115  pipelines-1.21 -> pipelines-1.21
```
