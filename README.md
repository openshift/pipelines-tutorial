...
You will use the simple application during this tutorial, which has a [frontend](https://github.com/openshift/pipelines-vote-ui/tree/pipelines-1.8) and [backend](https://github.com/openshift/pipelines-vote-api/tree/pipelines-1.8)
...
Now we need to configure webhook-url on [backend](https://github.com/openshift/pipelines-vote-api/tree/pipelines-1.8) and [frontend](https://github.com/openshift/pipelines-vote-ui/tree/pipelines-1.8) source code repositories with the Route we exposed in the previously.
...
>***Note:***
>
>Fork the [backend](https://github.com/openshift/pipelines-vote-api/tree/pipelines-1.8) and [frontend](https://github.com/openshift/pipelines-vote-ui/tree/pipelines-1.8) source code repositories so that you have sufficient privileges to configure GitHub webhooks.
...
- Follow above procedure to configure webhook on [frontend](https://github.com/openshift/pipelines-vote-ui/tree/pipelines-1.8) repo
...
When we perform any push event on the [backend](https://github.com/openshift/pipelines-vote-api/tree/pipelines-1.8) the following should happen.
