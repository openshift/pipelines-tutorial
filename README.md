...
You will use the simple application during this tutorial, which has a [frontend](https://github.com/openshift-pipelines/vote-ui/tree/pipelines-1.3) and [backend](https://github.com/openshift-pipelines/vote-api/tree/pipelines-1.3)
...
Now we need to configure webhook-url on [backend](https://github.com/openshift-pipelines/vote-api/tree/pipelines-1.3) and [frontend](https://github.com/openshift-pipelines/vote-ui/tree/pipelines-1.3) source code repositories with the Route we exposed in the previously.
...
>***Note:***
>
>Fork the [backend](https://github.com/openshift-pipelines/vote-api/tree/pipelines-1.3) and [frontend](https://github.com/openshift-pipelines/vote-ui/tree/pipelines-1.3) source code repositories so that you have sufficient privileges to configure GitHub webhooks.
...
- Follow above procedure to configure webhook on [frontend](https://github.com/openshift-pipelines/vote-ui/tree/pipelines-1.3) repo
...
When we perform any push event on the [backend](https://github.com/openshift-pipelines/vote-api/tree/pipelines-1.3) the following should happen.
...
```bash
$ git commit -m "empty-commit" --allow-empty && git push origin pipelines-1.3
...
Writing objects: 100% (1/1), 190 bytes | 190.00 KiB/s, done.
Total 1 (delta 0), reused 0 (delta 0)
To github.com:<github-username>/vote-api.git
   72c14bb..97d3115  pipelines-1.3 -> pipelines-1.3
```
