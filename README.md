...
You will use the simple application during this tutorial, which has a [frontend](https://github.com/openshift/pipelines-vote-ui/tree/pipelines-1.14) and [backend](https://github.com/openshift/pipelines-vote-api/tree/pipelines-1.14)
...
$ tkn pipeline start build-and-deploy \
    ...
    -w name=shared-workspace,volumeClaimTemplateFile=https://raw.githubusercontent.com/openshift/pipelines-tutorial/pipelines-1.14/01_pipeline/03_persistent_volume_claim.yaml \
...
Now we need to configure webhook-url on [backend](https://github.com/openshift/pipelines-vote-api/tree/pipelines-1.14) and [frontend](https://github.com/openshift/pipelines-vote-ui/tree/pipelines-1.14) source code repositories with the Route we exposed previously.
...
>***Note:***
>
>Fork the [backend](https://github.com/openshift/pipelines-vote-api/tree/pipelines-1.14) and [frontend](https://github.com/openshift/pipelines-vote-ui/tree/pipelines-1.14) source code repositories so that you have sufficient privileges to configure GitHub webhooks.
...
- Follow the above procedure to configure the webhook on [frontend](https://github.com/openshift/pipelines-vote-ui/tree/pipelines-1.14) repo
...
When we perform any push event on the [backend](https://github.com/openshift/pipelines-vote-api/tree/pipelines-1.14) the following should happen.
...
To github.com:<github-username>/pipelines-vote-api.git
   72c14bb..97d3115  pipelines-1.14 -> pipelines-1.14
```
