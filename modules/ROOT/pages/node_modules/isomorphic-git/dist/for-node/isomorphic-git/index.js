...
function buffer2stream (buffer) {
  let stream = new readableStream.PassThrough();
  stream.end(buffer);
  return stream
}
...
const pkg = {
  name: 'isomorphic-git',
  version: '0.47.0',
  agent: 'git/isomorphic-git@0.47.0'
};
...
class GitSideBand {
  static demux (input) {
    ...
    let packetlines = new readableStream.PassThrough();
    let packfile = new readableStream.PassThrough();
    let progress = new readableStream.PassThrough();
...
async function writeUploadPackRequest ({
  capabilities = [],
  wants = [],
  haves = [],
  shallows = [],
  ...
  let packstream = new readableStream.PassThrough();
